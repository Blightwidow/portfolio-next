export function SitemapIcon({ width, height }: { width: number; height: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" aria-label="sitemap" width={width} height={height}>
